...
<html lang="pt-br">
    <head>
        ...
        <title>Clube Amigo Audibel | Campanhas</title>
        ...
        <!-- itens AMP -->
        <link rel="canonical" href="campanhas.html">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <h2 class="text-center txt-vermelho">Campanhas</h2>
                        <p class="text-center txt-cinza">Confira as campanhas do Cartão Amigo Audibel</p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3">&nbsp;</div>
                </div>
            </div>
        ...
        <section id="CartaoAmigo" class="bkg-cinza-claro">
            ...
            <div class="container">
                ...
                <!--<div class="text-center">
                    <button class="btn_geral bkg-vermelho txt-branco"><span class="glyphicon glyphicon-repeat"></span> mais promoções</button>
                </div>-->
