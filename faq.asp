...
<html lang="pt-br">
    <head>
        ...
        <title>Clube Amigo Audibel | FAQ</title>
    ...
    <body id="">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <h2 class="text-center txt-vermelho">FAQ</h2>
                        <p class="text-center txt-cinza">Confira as perguntas mais frequentes e tire suas dúvidas.</p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3">&nbsp;</div>
                </div>
            </div>
        ...
        <!-- campanhas -->
        <section id="FAQ" class="bkg-cinza-claro">
            ...
            <div class="container">
                ...
                <ul class="btsFooter">
                    <li><img src="images/btVoltar.png" alt=""></li>
                    <li><img src="images/btTopo.png" alt=""></li>
                </ul>
